...
function foundation_assets() {
	...
	if (!is_admin()) {
		...
		// Load Stylesheets
		wp_enqueue_style( 'foundation', get_template_directory_uri().'/css/global.css' );
...
function foundation_js_init () {
    echo '<script type="text/javascript" src="'. get_template_directory_uri() .'/js/spfreaks.js"></script>';
}
...
require( get_template_directory() . '/inc/fn-helpers.php' );
