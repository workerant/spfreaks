    ...
    <div class="row bgblack">
      <div class="columns large-offset-2 large-10">
        <div class="row">
          <div class="columns large-1"><h6>Date</h6></div>
          <div class="columns large-3"><h6>Location</h6></div>
          <div class="columns large-2"><h6>Country</h6></div>
          <div class="columns large-1"><h6>Type</h6></div>
          <div class="columns large-3"><h6>Details</h6></div>
          <div class="columns large-2"><h6>Attended</h6></div>
        </div>
      </div>
    </div>
